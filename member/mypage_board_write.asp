						...
						<input type="hidden" name="titleImg" id="titleImg" value="<%=Cols_TitleImg%>">
                            ...
                            <div class="write_box">
                                ...
                                <div class="write_form">
                                    <div class="name">말머리</div>
                                    <div class="select_box common_write board">
                                        <input type="text" placeholder="말머리선택" readonly value="<%=Cols_SubTitleText%>">
                                        <ul>
                                            <li data-value="1">공지사항</li>
                                            <li data-value="2">이벤트</li>
                                            <li data-value="9">기타</li>
                                        </ul>
                                    </div>
                                </div>
								<%End If%>
                                ...
                                <!-- vod_select박스 -->
                                <div class="write_form">
                                    <div class="name">프로젝트선택</div>
                                    <div class="box_wrap_2 flex">
                                        <div class="select_box common_write vod">
                                            <input type="text" placeholder="프로젝트 선택" readonly id="project">
                                            <ul>
											<%
                                ...
                                <div class="write_form">
                                    ...
                                    <div class="wrap_box flex">
                                        ...
                                        <div class="common_write">
                                            <input type="text" id="fileInput" readonly value="<%=Cols_FileName%>" placeholder="파일이름">
                                        </div>
                                        <div class="file_btn">
                                ...
                                <div class="btn_box">
                                    ...
                                    <a href="javascript:;" class="add_btn common_submit_btn">저장하기</a>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    $(document).ready(function () {
		$("#file").change(function(){
			...
			$("#fileInput").attr("placeholder",$(this).val());
		});

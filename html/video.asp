...
<div class="click_modal_wrap">
    <div class="modal">
        <div class="click_modal_box common_modal_box">
            <div class="top_box">
                <div class="tit">영상보기</div>
            ...
            <div class="img_box video">
                ...
                <div class="btn_box">
					<button type="button" class="btn fir" id="linkSupport">후원단체</button>
                    <button type="button" class="btn" id="linkProject">후원프로젝트</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
		...
		//검은 배경 클릭시 레이어 닫기
		$(".click_modal_wrap .modal").click(function(e){		

...
<div id="container" class="en">
    ...
    <div class="mv">
        ...
        <div class="inner con_inner">
            ...
            <div class="mv_sub_txt">
                Zenit is a free sponsorship system.
            </div>
    ...
    <div class="con1 con">
        ...
        <div class="inner">
            ...
            <div class="common_tit_box animated d-1s">
                ...
                <div class="name">
                    Zenit service is also available <br class="hide-900"/>
                    as an app You can use it.
                </div>
            </div>
    ...
    <div class="con2 con">
        ...
        <div class="common_tit_box">
            ...
            <div class="name">How to apply for a sponsorship system</div>
        </div>
            ...
            <ul class="step_box" data-rolling-time="2000">
                ...
                <li class="box">
                    ...
                    <div class="txt_box">
                        ...
                        <div class="name">Register MVSI</div>
                    </div>
                </li>
                <li class="box">
                    <div class="img_wrap">
                    ...
                    <div class="txt_box">
                        ...
                        <div class="name">Certifying sponsors</div>
                    </div>
                </li>
                <li class="box">
                    <div class="img_wrap">
                    ...
                    <div class="txt_box">
                        ...
                        <div class="name">To register <br />A sponsored project</div>
                    </div>
                </li>
                <li class="box">
                    <div class="img_wrap">
                    ...
                    <div class="txt_box">
                        ...
                        <div class="name">To check <br />Sponsorship details</div>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="con3 con">
        <div class="inner">
            ...
            <div class="common_btn_box">
                <a href="javascript:;" class="common_btn">
                    <div class="txt">More Sponsoring Groups</div>
                </a>
            </div>
            ...
            <div class="con4 con">
                <div class="common_tit_box">
                    ...
                    <div class="name">
                        Sponsored Group Activity Photo
        ...
        <div class="con4_slide_wrap">
            <div class="swiper mySwiper con4_slide">
                <div class="swiper-wrapper">
                    <div class="swiper-slide item">
                        <div class="img_wrap">
                            <img src="../image/main/con4_img_01.png" alt="">
                        </div>
                        <div class="name text_ov">세이브 더 칠드런</div>
                        <div class="alt text_ov2">
                            후원단체에서 진행한 “따뜻한 도시 <br />
                            락 나눔” 캠페인 사진입니다.
                        </div>
        ...
        <div class="common_btn_box">
            <a href="javascript:;" class="common_btn">
                <div class="txt">More activity photos</div>
            </a>
        </div>
    </div>
    <!-- END con3 -->
            ...
            <div class="con5_slide_box animated d-1s">
                <div class="swiper mySwiper con5_slide">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide item">
                            <div class="img_box">
                                <img src="../image/main/con5_img_01.png" alt="">
                            </div>
                            <div class="name text_ov2">
                                뉴스제목 최대 두줄이 보여집니다 두줄 <br />
                                이상 길어지면 점점점으로 처리됩니다다다다다
                            </div>
                        ...
                        <div class="swiper-slide item">
                            <div class="img_box">
                                <img src="../image/main/con5_img_02.png" alt="">
                            </div>
                            <div class="name text_ov2">
                                뉴스제목 최대 두줄이 보여집니다 두줄 <br />
                                이상 길어지면 점점점으로 처리됩니다다다다다
                        ...
                        <div class="swiper-slide item">
                            <div class="img_box">
                                <img src="../image/main/con5_img_03.png" alt="">
                            </div>
                            <div class="name text_ov2">
                                뉴스제목 최대 두줄이 보여집니다 두줄 <br />
                                이상 길어지면 점점점으로 처리됩니다다다다다
    ...
    <!-- con6 -->
    <div class="con6 con scale en">
        <div class="inner">
            <div class="common_tit_box animated d-1s">
                <div class="name">
                    <span>Everywhere love is needed</span> <br class="hide-900"/>
                    Zenit is with you.
                </div>
            </div>
            ...
            <div class="common_btn_box animated d-3s">
                <a href="javascript:;" class="common_btn a">
                    <div class="txt">Proposal Down</div>
                    <div class="down"></div>
                </a>

                <a href="javascript:;" class="common_btn center">
                    <div class="txt">Sponsorship system application</div>
                </a>
            </div>
        </div>
    </div>

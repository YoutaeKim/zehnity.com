...
<!--#include virtual="/common/lib/freeASPUpload.asp" --><%
	...
	If Not(fileInfo = "" Or IsNull(fileInfo)) Then
		...
		If fileSize = 0 Then
			...
			bRet = 1
		ElseIf UCase(fileExt) = "JPG" Or UCase(fileExt) = "GIF" Or UCase(fileExt) = "PNG" Or UCase(fileExt) = "ZIP" Or UCase(fileExt) = "XLS" Or UCase(fileExt) = "XLSX" Or UCase(fileExt) = "DOC" Or UCase(fileExt) = "PDF"  Then

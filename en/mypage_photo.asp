            ...
            <div class="inner con_inner">
                <div class="mypage_box_wrap">
                    ...
                    <div class="mypage_tit">
                        PHOTO
                        <div class="sub_tit">
                            <span>Registered PHOTO can be shared with the Zenity website.</span>
                            <a href="mypage_board_write.asp?bType=B0104" class="add_btn common_submit_btn">Writing</a>
                        </div>
                    </div> 
<%
	If IsArray(arrList) Then 

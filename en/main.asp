    ...
    <div class="con3 con">
        <div class="inner">
            ...
            <div class="common_btn_box">
                <a href="/en/support.asp" class="common_btn">
...
%>
        ...
        <div class="common_btn_box">
            <a href="/en/photo.asp" class="common_btn">
...
<%
	If IsArray(arrNewsList) Then
		For i = 0 To UBound(arrNewsList,2)
			...
			End If
%>                        
						<div class="swiper-slide item" onclick="location.href='/en/news_room_view.asp?bCode=<%=arrNewsList(0, i)%>';" style="cursor:pointer;">
                            <div class="img_box">
                                <img src="<%=Cols_TitleImg%>" alt="">
                            </div>
    ...
    <div class="con6 con scale en">
        <div class="inner">
            ...
            <div class="common_btn_box animated d-3s">
                ...
                <a href="/en/system.asp" class="common_btn center">

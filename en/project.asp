        ...
        <div class="sub_wrap two">
            <div class="inner con_inner">
                <div class="sub_top_tab">
                    <div class="link<%If iPtype = "0" Then%> active<%End If%>" data-ptype="0">Ongoing sponsorship project</div>
                    <div class="link<%If iPtype = "1" Then%> active<%End If%>" data-ptype="1">End Sponsored Projects</div>
                </div>
                <div class="content">
...
<%
	If IsArray(arrList) Then
		...
		If Not(arrList(9, i) = "" Or IsNull(arrList(9, i))) Then
			Cols_Logoimg = " style='background: url(" & arrList(9, i) & ") no-repeat center;'"
		Else
			Cols_Logoimg = ""
		End If
		If iPtype = 0 Then
